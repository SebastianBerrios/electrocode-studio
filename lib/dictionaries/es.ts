...
export const es: Dictionary = {
  ...
  templates: {
    ...
    previewHint: "Desliza dentro del teléfono para recorrer la plantilla completa.",
    previewBadge: "¡Desliza!",
    previewFrameLabel: "Vista previa de la plantilla {name} dentro de un teléfono",
    demoCta: "Ver ejemplo",
